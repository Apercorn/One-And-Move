...
import { TAXI_STANDS, TAXI_STAND_MAP } from "@One-and-Move/db/data/taxi-stands";
...
const POPULAR_TAXI_ROUTES: ReadonlyArray<{
  ...
  { fromStandId: "half-way-tree", toStandId: "papine", label: "HWT → Papine", fare: 200 },
  { fromStandId: "cross-roads", toStandId: "downtown-kingston", label: "Cross Roads → Downtown", fare: 200 },
  { fromStandId: "liguanea", toStandId: "half-way-tree", label: "Liguanea → HWT", fare: 200 },
  { fromStandId: "constant-spring", toStandId: "cross-roads", label: "Constant Spring → Cross Roads", fare: 220 },
  { fromStandId: "barbican", toStandId: "papine", label: "Barbican → Papine", fare: 200 },
  { fromStandId: "downtown-kingston", toStandId: "half-way-tree", label: "Downtown → HWT", fare: 200 },
  { fromStandId: "portmore", toStandId: "half-way-tree", label: "Portmore → HWT", fare: 350 },
  { fromStandId: "greater-portmore", toStandId: "downtown-kingston", label: "Greater Portmore → Downtown", fare: 400 },
  { fromStandId: "naggo-head", toStandId: "spanish-town", label: "Naggo Head → Spanish Town", fare: 300 },
  { fromStandId: "waterford", toStandId: "portmore", label: "Waterford → Portmore", fare: 200 },
  { fromStandId: "spanish-town", toStandId: "half-way-tree", label: "Spanish Town → HWT", fare: 400 },
  { fromStandId: "old-harbour", toStandId: "spanish-town", label: "Old Harbour → Spanish Town", fare: 350 },
  { fromStandId: "ochorios", toStandId: "moneague", label: "Ocho Rios → Moneague", fare: 350 },
  { fromStandId: "ochorios", toStandId: "stanns-bay", label: "Ocho Rios → St Ann's Bay", fare: 250 },
  { fromStandId: "runaway-bay", toStandId: "ochorios", label: "Runaway Bay → Ocho Rios", fare: 300 },
  { fromStandId: "port-maria", toStandId: "annotto-bay", label: "Port Maria → Annotto Bay", fare: 250 },
  { fromStandId: "montego-bay", toStandId: "falmouth", label: "Montego Bay → Falmouth", fare: 400 },
  { fromStandId: "montego-bay", toStandId: "anchovy", label: "Montego Bay → Anchovy", fare: 250 },
  { fromStandId: "cambridge", toStandId: "montego-bay", label: "Cambridge → Montego Bay", fare: 550 },
] as const;
...
function buildGraph(): TransitGraph {
  ...
  const addNode = (id: string, name: string, lat: number, lng: number, kind: "bus" | "taxi") => {
